...
const Header = () => {
    ...
    return (
        <header className={styles.header}>
            ...
            >
                <Icon height={25} fill="var(--yellow)" className={styles.icon} />
                <HanoiGo height={15} fill="#fff" className={styles.hanoiGo} />
            </div>
